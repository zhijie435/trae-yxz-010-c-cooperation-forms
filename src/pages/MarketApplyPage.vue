...
import { ref } from 'vue'
import MarketApplyForm from '@/components/MarketApplyForm.vue'
  ...
  <div class="grain relative min-h-screen w-full overflow-x-hidden">
    ...
    >
      <header class="flex items-center justify-between animate-rise">
        <div class="flex items-center gap-3">
          ...
          <div class="leading-tight">
            <p class="font-serif text-[15px] font-semibold text-ink">市场合作申请</p>
            <p class="text-[10px] uppercase tracking-[0.22em] text-muted">Marketing Partnership</p>
          </div>
        </div>
        <span
      ...
      <section class="mt-12 animate-rise" style="animation-delay: 80ms">
        <p class="mb-3 text-[11px] uppercase tracking-[0.3em] text-gold">Cooperation Application</p>
        ...
        <p class="mt-4 max-w-xl text-sm leading-relaxed text-ink-soft">
          填写您的企业或个人信息，分享您的业务介绍与合作优势，我们将尽快与您联系，共同探索合作机会。提交后将生成专属回执编号，便于后续跟进。
        </p>
      ...
      <main class="mt-8 flex-1">
        ...
        <MarketApplyForm v-else @success="onSuccess" />
      </main>
      ...
      >
        <span>© 2026 市场合作计划</span>
        <span>提交即代表同意信息用于合作审核</span>
      </footer>
    </div>
  </div>
</template>
