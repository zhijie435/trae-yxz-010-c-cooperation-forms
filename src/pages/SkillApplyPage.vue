...
import { ref } from 'vue'
import SkillApplyForm from '@/components/SkillApplyForm.vue'
  ...
  <div class="grain relative min-h-screen w-full overflow-x-hidden">
    ...
    >
      <header class="flex items-center justify-between animate-rise">
        <div class="flex items-center gap-3">
          ...
          <div class="leading-tight">
            <p class="font-serif text-[15px] font-semibold text-ink">技能作者合作</p>
            <p class="text-[10px] uppercase tracking-[0.22em] text-muted">Skill Author Partnership</p>
          </div>
        </div>
        <span
      ...
      <section class="mt-12 animate-rise" style="animation-delay: 80ms">
        <p class="mb-3 text-[11px] uppercase tracking-[0.3em] text-gold">Creator Application</p>
        ...
        <p class="mt-4 max-w-xl text-sm leading-relaxed text-ink-soft">
          分享您在硬件或软件领域的专业技能与作品，携手打造高质量的技术内容生态。提交后将生成专属回执编号，便于后续跟进。
        </p>
      ...
      <main class="mt-8 flex-1">
        ...
        <SkillApplyForm v-else @success="onSuccess" />
      </main>
